...
{-| -}
rakuten : List (Attribute msg) -> Color -> Int -> Element.Element msg
...
{-| -}
r : List (Attribute msg) -> Color -> Int -> Element.Element msg
r attrs cl size =
    R10.Svg.Utils.wrapperWithViewbox attrs
        "7 4.6 22 22"
        size
...
{-| -}
rakutenMarketing : List (Attribute msg) -> Color -> Int -> Element.Element msg
...
{-| -}
rakutenRagri : List (Attribute msg) -> Color -> Int -> Element.Element msg
...
{-| -}
rakutenReady : List (Attribute msg) -> Color -> Int -> Element.Element msg
...
{-| -}
authenticator : List (Attribute msg) -> Color -> Int -> Element.Element msg
...
{-| -}
authenticator_monochrome : List (Attribute msg) -> Color -> Int -> Element.Element msg
