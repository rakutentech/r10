...
wrapperWithViewbox ySize viewbox listSvg =
    Svg.svg
...
arrowBack : String -> Int -> Svg.Svg msg
arrowBack color size =
    wrapperWithViewbox
        size
        "0 0 24 24"
...
arrowForward : String -> Int -> Svg.Svg msg
arrowForward color size =
    wrapperWithViewbox
        size
        "0 0 24 24"
...
notice_generic_l_ color size =
    wrapperWithViewbox
        size
        "0 0 32 32"
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.fill color, SA.d "M16 28a2 2 0 0 1-2-2h-2a4 4 0 0 0 8 0h-2a2 2 0 0 1-2 2zm10-8v-8a10 10 0 0 0-20 0v8a2 2 0 0 1-2 2v2h24v-2a2 2 0 0 1-2-2zM7.46 22A3.98 3.98 0 0 0 8 20v-8a8 8 0 0 1 16 0v8a3.98 3.98 0 0 0 .54 2z" ] []
        ]
...
checkBold_ : String -> Int -> Svg.Svg msg
checkBold_ cl size =
    wrapperWithViewbox
        size
        "0 0 12 10"
        [ Svg.path [ SA.fill cl, SA.d "M11.75.78a.72.72 0 0 0-1.03 0l-6.5 6.95-2.98-3a.64.64 0 0 0-.52-.2c-.2 0-.38.08-.52.24a.79.79 0 0 0-.2.53c0 .2.09.4.23.54l3.5 3.5c.14.14.33.22.52.22.2 0 .4-.08.52-.22l7.01-7.47A.81.81 0 0 0 12 1.3a.87.87 0 0 0-.25-.52z" ] []
        ]


sign_warning_f_ : String -> Int -> Svg.Svg msg
sign_warning_f_ cl size =
    wrapperWithViewbox
        size
        "0 0 32 32"
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
...
sign_warning_l_ : String -> Int -> Svg.Svg msg
sign_warning_l_ cl size =
    wrapperWithViewbox
        size
        "0 0 32 32"
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
...
eye_ban_f_ : String -> Int -> Svg.Svg msg
eye_ban_f_ cl size =
    wrapperWithViewbox size
        "0 0 32 32"
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
...
eye_ban_l_ : String -> Int -> Svg.Svg msg
eye_ban_l_ cl size =
    wrapperWithViewbox size
        "0 0 32 32"
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
...
keyboardArrowDown : String -> Int -> Svg.Svg msg
keyboardArrowDown color size =
    wrapperWithViewbox
        size
        "0 0 24 24"
        [ Svg.path [ SA.fill color, SA.d "M8.12 9.29L12 13.17l3.88-3.88c.39-.39 1.02-.39 1.41 0 .39.39.39 1.02 0 1.41l-4.59 4.59c-.39.39-1.02.39-1.41 0L6.7 10.7c-.39-.39-.39-1.02 0-1.41.39-.38 1.03-.39 1.42 0z" ] []
        ]


validation_clear_ : String -> Int -> Svg.Svg msg
validation_clear_ color size =
    wrapperWithViewbox
        size
        -- make icon a bit bigger
        "2 2 20 20"
        [ Svg.path [ SA.fill color, SA.d "M18.3 5.71c-.39-.39-1.02-.39-1.41 0L12 10.59 7.11 5.7c-.39-.39-1.02-.39-1.41 0-.39.39-.39 1.02 0 1.41L10.59 12 5.7 16.89c-.39.39-.39 1.02 0 1.41.39.39 1.02.39 1.41 0L12 13.41l4.89 4.89c.39.39 1.02.39 1.41 0 .39-.39.39-1.02 0-1.41L13.41 12l4.89-4.89c.38-.38.38-1.02 0-1.4z" ] []
        ]


validation_error_ : String -> Int -> Svg.Svg msg
validation_error_ color size =
    wrapperWithViewbox
        size
        "0 0 24 24"
        [ Svg.path [ SA.fill color, SA.d "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" ] []
        ]


validation_check_ : String -> Int -> Svg.Svg msg
validation_check_ color size =
    wrapperWithViewbox
        size
        "0 0 24 24"
...
delete : String -> Int -> Svg.Svg msg
delete color size =
    wrapperWithViewbox
        size
        "0 0 24 24"
        [ Svg.path [ SA.fill color, SA.d "M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v10zM9 9h6c.55 0 1 .45 1 1v8c0 .55-.45 1-1 1H9c-.55 0-1-.45-1-1v-8c0-.55.45-1 1-1zm6.5-5l-.71-.71c-.18-.18-.44-.29-.7-.29H9.91c-.26 0-.52.11-.7.29L8.5 4H6c-.55 0-1 .45-1 1s.45 1 1 1h12c.55 0 1-.45 1-1s-.45-1-1-1h-2.5z" ] []
        ]


restore : String -> Int -> Svg.Svg msg
restore color size =
    wrapperWithViewbox
        size
        "0 0 24 24"
        [ Svg.path [ SA.fill color, SA.d "M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v10zm5.65-8.65c.2-.2.51-.2.71 0L16 14h-2v4h-4v-4H8l3.65-3.65zM15.5 4l-.71-.71c-.18-.18-.44-.29-.7-.29H9.91c-.26 0-.52.11-.7.29L8.5 4H6c-.55 0-1 .45-1 1s.45 1 1 1h12c.55 0 1-.45 1-1s-.45-1-1-1h-2.5z" ] []
        ]


keyboardArrowUp : String -> Int -> Svg.Svg msg
keyboardArrowUp color size =
    wrapperWithViewbox
        size
        "0 0 24 24"
        [ Svg.path [ SA.fill color, SA.d "M8.12 14.71L12 10.83l3.88 3.88c.39.39 1.02.39 1.41 0 .39-.39.39-1.02 0-1.41L12.7 8.71c-.39-.39-1.02-.39-1.41 0L6.7 13.3c-.39.39-.39 1.02 0 1.41.39.38 1.03.39 1.42 0z" ] []
        ]


more_vert_ : String -> Int -> Svg.Svg msg
more_vert_ cl size =
    wrapperWithViewbox size
        "0 0 48 48"
        [ Svg.path [ SA.fill cl, SA.d "M24 16a4 4 0 100-8 4 4 0 000 8zm0 4a4 4 0 100 8 4 4 0 000-8zm0 12a4 4 0 100 8 4 4 0 000-8z" ] []
        ]


aToZ : String -> Int -> Svg.Svg msg
aToZ _ size =
    wrapperWithViewbox size
        "0 0 512 512"
