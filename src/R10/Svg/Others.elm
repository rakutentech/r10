...
{-| -}
spinnerRotation : Int -> String -> Element.Element msg
spinnerRotation size colorString =
    let
        idElement =
            "r10_spinner"
        ...
        speed =
            "0.6s"
    in
    R10.Svg.wrapperWithViewbox "0 0 38 38"
        size
        [ Svg.defs []
            [ Svg.linearGradient
...
{-| -}
mobileWithPerson : String -> Int -> Element.Element msg
mobileWithPerson cl size =
    R10.Svg.wrapperWithViewbox
        "0 0 209 160"
        size
        ...
        , Svg.path [ SA.fill cl, SA.d "M94.88 7.62c-.15.14-.32.28-.49.4a25.83 25.83 0 0016.68 12.42v-.65a25.22 25.22 0 01-16.2-12.17zM82.54 8.99h-.67a37.47 37.47 0 0029.2 23.32v-.64A36.83 36.83 0 0182.54 8.99z" ] []
        ...
        , Svg.path [ SA.fill cl, SA.d "M66.7 89.42a16.5 16.5 0 100-33 16.5 16.5 0 000 33z", SA.opacity ".2" ] []
        , Svg.path [ SA.fill cl, SA.d "M66.7 84.54a11.62 11.62 0 100-23.24 11.62 11.62 0 000 23.24z", SA.opacity ".2" ] []
        , Svg.path [ SA.fill cl, SA.d "M66.7 80.59a7.67 7.67 0 100-15.34 7.67 7.67 0 000 15.34z" ] []
        ...
        , Svg.path [ SA.fill cl, SA.d "M128.79 36.68l1.89-.66s-.75 1.23 3.25 1.95c4 .71 8.15.97 10-1.38 0 0 .72-.34 1.72.66s1.57.72 1.57.72l-.71 3.71-1.43 6.86-1.86 5.15-5.29-1.15-5.71-4.14-2.15-5.57v-5.15l-1.28-1z" ] []
        , Svg.path [ SA.fill cl, SA.d "M146.22 38.68l1.43-1s4.86.86 5.14 3.15l-3.71 7.14c.76 1.99.7 4.2-.14 6.14-1.43 3.3-1.29 4-1.29 4l-1 4.3-18.15 1.42s-.71-1.71-1-2c-.28-.29-.28-1.29 0-1.29.29 0 0-.42-.28-.85-.29-.43-.43-.57 0-1.15.43-.57-.72-5.71-.72-5.71v-5.57l-4.86-6.43s1.72-2.58 2.58-2.86c.85-.29 4.93-1.41 4.93-1.41l.92 1.35 1.3 10.35 1.85 6.28 7.82-1.33 3.04-5.1 2-6 .14-3.43z" ] []
        , Svg.path [ SA.fill cl, SA.d "M151.65 39.97l1.14.86s1 8 .72 8.57c-.29.57-5.29 1.14-5.43.86-.14-.29 3.57-10.3 3.57-10.3z" ] []
        ...
        , Svg.path [ SA.fill cl, SA.d "M118.52 98.5a5.57 5.57 0 10-1.75-2.17l-14.58 12.14-1.94-2.3-.88.58-.97-1.15.8-.67-.97-1.16-1.24 1.05.6.71-1.33 1.12-.6-.7-1.95 1.63.9 1.07.7-.6.98 1.15-.89.75 1.8 2.13-2.13 1.79 2.16 2.57 21.3-17.94zm3.64-8.14a3.69 3.69 0 11-.63 7.34 3.69 3.69 0 01.63-7.34z" ] []
        ...
        , Svg.path [ SA.fill cl, SA.d "M122.79 40.4l-1.15.43s-2.14 9-1.57 9c.58 0 7.43.86 7.43.57 0-.29-1.28-7.29-1.28-7.29l-3.43-2.71z" ] []
        ]


{-| -}
mountain : Int -> Element.Element msg
mountain size =
    R10.Svg.wrapperWithViewbox
        "0 0 152 148"
        size
