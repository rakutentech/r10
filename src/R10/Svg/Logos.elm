...
rakuten attrs color size =
    el attrs <|
        rakuten_ (Color.Convert.colorToCssRgba color) size


{-| -}
rakuten_ : String -> Int -> Element.Element msg
rakuten_ colorAsString size =
    wrapperWithViewbox "0 0 166 50"
        size
        [ Svg.path
            [ SA.fill colorAsString
...
{-| -}
authenticator : String -> Int -> Element.Element msg
...
{-| -}
authenticator_monocrome : String -> Int -> Element.Element msg
authenticator_monocrome cl size =
    wrapperWithViewbox "0 0 77 77"
        ...
        , Svg.path [ SA.fill cl, SA.d authenticator_shapeSquare, SA.mask "url(#authenticator_mask)" ] []
        , Svg.path [ SA.fill cl, SA.d authenticator_shapeR ] []
        ]
