...
{-| -}
arrow_down_l : String -> Int -> Element.Element ms
arrow_down_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill cl, SA.d "M28 18l-1.4-1.4-9.6 9.6V2h-2v24.2l-9.6-9.6L4 18l12 12 12-12z" ] []
        , Svg.path [ SA.fill "none", SA.d "M32 0v32H0V0z" ] []
        ]


{-| -}
arrow_left_l : String -> Int -> Element.Element msg
arrow_left_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill cl, SA.d "M14 28l1.4-1.4L5.8 17H30v-2H5.8l9.6-9.6L14 4 2 16l12 12z" ] []
        , Svg.path [ SA.fill "none", SA.d "M32 32H0V0h32z" ] []
        ]


{-| -}
arrow_right_l : String -> Int -> Element.Element msg
arrow_right_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill cl, SA.d "M18 4l-1.4 1.4 9.6 9.6H2v2h24.2l-9.6 9.6L18 28l12-12L18 4z" ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
arrow_link_l : String -> Int -> Element.Element msg
arrow_link_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill cl, SA.d "M16 4l-1.4 1.4 9.6 9.6H4v2h20.2l-9.6 9.6L16 28l12-12L16 4z" ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
arrow_up_l : String -> Int -> Element.Element msg
arrow_up_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill cl, SA.d "M4 14l1.4 1.4L15 5.8V30h2V5.8l9.6 9.6L28 14 16 2 4 14z" ] []
        , Svg.path [ SA.fill "none", SA.d "M0 32V0h32v32z" ] []
        ]


{-| -}
barcode_f : String -> Int -> Element.Element msg
barcode_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
browsing_history_l : String -> Int -> Element.Element msg
...
{-| -}
building_f : String -> Int -> Element.Element msg
building_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
building_l : String -> Int -> Element.Element msg
building_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
bus_f : String -> Int -> Element.Element msg
bus_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M24 2H8a4 4 0 0 0-4 4v18a2 2 0 0 0 2 2v2a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-2h10v2a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-2a2 2 0 0 0 2-2V6a4 4 0 0 0-4-4zM9.5 22a1.5 1.5 0 1 1 1.5-1.5A1.5 1.5 0 0 1 9.5 22zm13 0a1.5 1.5 0 1 1 1.5-1.5 1.5 1.5 0 0 1-1.5 1.5zm3.5-7H6V7h20z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
bus_l : String -> Int -> Element.Element msg
bus_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
button_chevron_left_f : String -> Int -> Element.Element msg
button_chevron_left_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 0a16 16 0 1 0 16 16A16 16 0 0 0 16 0zm4.21 24.29L18.8 25.7 9.09 16l9.71-9.71 1.41 1.41-8.3 8.3z", SA.fill cl ] []
        ]


{-| -}
button_chevron_left_l : String -> Int -> Element.Element msg
button_chevron_left_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 0a16 16 0 1 0 16 16A16 16 0 0 0 16 0zm0 30a14 14 0 1 1 14-14 14 14 0 0 1-14 14z", SA.fill cl ] []
        , Svg.path [ SA.fill cl, SA.d "M18.79 6.29L9.09 16l9.7 9.71 1.42-1.42-8.3-8.29 8.3-8.29-1.42-1.42z" ] []
        ]


{-| -}
button_chevron_right_f : String -> Int -> Element.Element msg
button_chevron_right_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 0a16 16 0 1 0 16 16A16 16 0 0 0 16 0zm-2.79 25.71L11.8 24.3l8.29-8.3-8.3-8.29L13.2 6.3l9.71 9.7z", SA.fill cl ] []
        ]


{-| -}
button_chevron_right_l : String -> Int -> Element.Element msg
button_chevron_right_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 0a16 16 0 1 0 16 16A16 16 0 0 0 16 0zm0 30a14 14 0 1 1 14-14 14 14 0 0 1-14 14z", SA.fill cl ] []
        , Svg.path [ SA.fill cl, SA.d "M11.79 7.71l8.3 8.29-8.3 8.29 1.42 1.42 9.7-9.71-9.7-9.71-1.42 1.42z" ] []
        ]


{-| -}
button_minus_f : String -> Int -> Element.Element msg
button_minus_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 0a16 16 0 1 0 16 16A16 16 0 0 0 16 0zm9 17H7v-2h18z", SA.fill cl ] []
        ]


{-| -}
button_minus_l : String -> Int -> Element.Element msg
button_minus_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 0a16 16 0 1 0 16 16A16 16 0 0 0 16 0zm0 30a14 14 0 1 1 14-14 14 14 0 0 1-14 14z", SA.fill cl ] []
        , Svg.path [ SA.fill cl, SA.d "M7 15h18v2H7z" ] []
        ]


{-| -}
button_plus_f : String -> Int -> Element.Element msg
button_plus_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 0a16 16 0 1 0 16 16A16 16 0 0 0 16 0zm9 17h-8v8h-2v-8H7v-2h8V7h2v8h8z", SA.fill cl ] []
        ]


{-| -}
button_plus_l : String -> Int -> Element.Element msg
button_plus_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 0a16 16 0 1 0 16 16A16 16 0 0 0 16 0zm0 30a14 14 0 1 1 14-14 14 14 0 0 1-14 14z", SA.fill cl ] []
        , Svg.path [ SA.fill cl, SA.d "M17 7h-2v8H7v2h8v8h2v-8h8v-2h-8V7z" ] []
        ]


{-| -}
calculator_f : String -> Int -> Element.Element msg
calculator_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M3 25a4 4 0 0 0 4 4h8V17H3zm3.04-3.54l1.42-1.42L9 21.6l1.55-1.56 1.42 1.42L10.42 23l1.56 1.55-1.42 1.42-1.55-1.56-1.55 1.56-1.42-1.42 1.56-1.55zM3 7v8h12V3H7a4 4 0 0 0-4 4zm5-1h2v2h2v2h-2v2H8v-2H6V8h2zm9 23h8a4 4 0 0 0 4-4v-8H17zm3-9h6v2h-6zm0 4h6v2h-6zm5-21h-8v12h12V7a4 4 0 0 0-4-4zm1 7h-6V8h6z", SA.fill cl ] []
        ]


{-| -}
calculator_l : String -> Int -> Element.Element msg
...
{-| -}
calendar_f : String -> Int -> Element.Element msg
calendar_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M27 5h-3V3h-2v2H10V3H8v2H5a2 2 0 0 0-2 2v5h26V7a2 2 0 0 0-2-2zM3 27a2 2 0 0 0 2 2h22a2 2 0 0 0 2-2V14H3zm13-8v-2h6v2l-3.75 7H16l3.73-7zm-5-2h3v9h-2v-7h-1z", SA.fill cl ] []
        ]


{-| -}
calendar_l : String -> Int -> Element.Element msg
calendar_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
cart_f : String -> Int -> Element.Element msg
cart_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
cart_l : String -> Int -> Element.Element msg
cart_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
            [ Svg.circle [ SA.cx "11", SA.cy "28", SA.r "2" ] []
...
{-| -}
change_order_l : String -> Int -> Element.Element msg
change_order_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M32 32H0V0h32z" ] []
        , Svg.path [ SA.d "M22.99 4L16 10.99l1.37 1.37L22 7.72V28h2V7.75l4.6 4.6L29.99 11l-7-6.99zM9.98 24.28V4h-2v20.25l-4.61-4.6L2 21 8.99 28l6.99-6.99-1.37-1.37-4.63 4.64z", SA.fill cl ] []
        ]


{-| -}
check : String -> Int -> Element.Element msg
check cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.fill cl, SA.fillRule "evenodd", SA.d "M30 7l-1.41-1.41L11 23.17 3.41 15.6 2 17l9 9L30 7z" ] []
        ]


{-| -}
chevron_left : String -> Int -> Element.Element msg
chevron_left cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M32 32H0V0h32z" ] []
        , Svg.path [ SA.fill cl, SA.fillRule "evenodd", SA.d "M21.8 29l1.4-1.41L11.63 16 23.21 4.41 21.79 3l-13 13 13 13z" ] []
        ]


{-| -}
chevron_right : String -> Int -> Element.Element msg
chevron_right cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.fill cl, SA.fillRule "evenodd", SA.d "M10.2 3L8.8 4.41 20.37 16 8.79 27.59 10.21 29l13-13-13-13z" ] []
        ]


{-| -}
cloud_f : String -> Int -> Element.Element msg
cloud_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M30 22a5.99 5.99 0 0 0-2.2-4.65A4.95 4.95 0 0 0 28 16a5 5 0 0 0-5-5 4.95 4.95 0 0 0-1.5.25A8 8 0 0 0 6 14c0 .23.01.45.03.67A7 7 0 0 0 9 28h15.5v-.03A6 6 0 0 0 30 22z", SA.fill cl ] []
        ]


{-| -}
cloud_l : String -> Int -> Element.Element msg
cloud_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
...
{-| -}
code_f : String -> Int -> Element.Element msg
code_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M28 7H16l-1.37-2.86A2 2 0 0 0 12.83 3H5.5a2 2 0 0 0-1.92 1.45L2 10v17a2 2 0 0 0 2 2h24a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z", SA.fill cl ] []
...
{-| -}
code_l : String -> Int -> Element.Element msg
code_l cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M10.7 22.7L6 18l4.7-4.7 1.42 1.4-3.3 3.3 3.3 3.3-1.41 1.4zm10.6 0l-1.42-1.4 3.3-3.3-3.3-3.3 1.41-1.4L26 18l-4.7 4.7zM14.91 25L13 24.42 17.08 11l1.92.58L14.92 25z", SA.fill cl ] []
        , Svg.path [ SA.d "M28 7H16l-1.37-2.86A2 2 0 0 0 12.83 3H5.5a2 2 0 0 0-1.92 1.45L2 10v17a2 2 0 0 0 2 2h24a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2zm0 20H4V10.28L5.5 5h7.33l1.36 2.86.55 1.14H28z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
comment_f : String -> Int -> Element.Element msg
comment_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
comment_l : String -> Int -> Element.Element msg
comment_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
coupon_f : String -> Int -> Element.Element msg
coupon_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M30 13V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v7a3 3 0 0 1 0 6v7a2 2 0 0 0 2 2h24a2 2 0 0 0 2-2v-7a3 3 0 0 1 0-6zm-17 5h-2v-4h2zm0-6h-2V8h2zm0 12h-2v-4h2z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
coupon_l : String -> Int -> Element.Element msg
coupon_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
credit_card_f : String -> Int -> Element.Element msg
credit_card_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M2 25a2 2 0 0 0 2 2h24a2 2 0 0 0 2-2V14H2zm10.5-5a1.5 1.5 0 1 1-1.5 1.5 1.5 1.5 0 0 1 1.5-1.5zm-5 0A1.5 1.5 0 1 1 6 21.5 1.5 1.5 0 0 1 7.5 20zM28 5H4a2 2 0 0 0-2 2v3h28V7a2 2 0 0 0-2-2z", SA.fill cl ] []
        ]


{-| -}
credit_card_l : String -> Int -> Element.Element msg
...
{-| -}
currency_f : String -> Int -> Element.Element msg
currency_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
currency_l : String -> Int -> Element.Element msg
currency_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
delete_f : String -> Int -> Element.Element msg
delete_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M6 28.17A1.92 1.92 0 0 0 8 30h16a1.92 1.92 0 0 0 2-1.83V9H6zM20 12h2v15h-2zm-5 0h2v15h-2zm-5 0h2v15h-2zm9-7a3 3 0 0 0-6 0H4v2h24V5z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
delete_l : String -> Int -> Element.Element msg
delete_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
delivery_f : String -> Int -> Element.Element msg
delivery_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ]
            []
        ...
        , Svg.path [ SA.d "M17 4H5a2 2 0 0 0-2 2v19a2 2 0 0 0 2 2h2.18a2.98 2.98 0 0 0 5.64 0H19V6a2 2 0 0 0-2-2zm-7 23a1 1 0 1 1 1-1 1 1 0 0 1-1 1zM25 8h-4v19h1.18a2.98 2.98 0 0 0 5.64 0H28a2 2 0 0 0 2-2v-7zm0 19a1 1 0 1 1 1-1 1 1 0 0 1-1 1zm-2-9v-6h1.76l3 6z", SA.fill cl ] []
        ]


{-| -}
delivery_l : String -> Int -> Element.Element msg
delivery_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M25 8h-4v2h2.76l1 2H23v6h4.76l.24.47V25h-.18a2.98 2.98 0 0 0-5.64 0H21v2h1.18a2.98 2.98 0 0 0 5.64 0H28a2 2 0 0 0 2-2v-7zm0 19a1 1 0 1 1 1-1 1 1 0 0 1-1 1zM17 4H5a2 2 0 0 0-2 2v19a2 2 0 0 0 2 2h2.18a2.98 2.98 0 0 0 5.64 0H19V6a2 2 0 0 0-2-2zm-7 23a1 1 0 1 1 1-1 1 1 0 0 1-1 1zm7-2h-4.18a2.98 2.98 0 0 0-5.64 0H5V6h12z", SA.fill cl ] []
        ]


{-| -}
desktop_f : String -> Int -> Element.Element msg
desktop_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
desktop_l : String -> Int -> Element.Element msg
desktop_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
domestic_area_f : String -> Int -> Element.Element msg
...
{-| -}
domestic_area_l : String -> Int -> Element.Element msg
...
{-| -}
download_f : String -> Int -> Element.Element msg
download_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
download_l : String -> Int -> Element.Element msg
download_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
favorite_f : String -> Int -> Element.Element msg
favorite_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
ferry_l : String -> Int -> Element.Element msg
ferry_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
fill_color_f : String -> Int -> Element.Element msg
fill_color_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M24 27a3 3 0 0 1 .29-1.3C24.78 24.7 27 21 27 21s2.22 3.7 2.71 4.7A3 3 0 1 1 24 27zM16 3l-2 2-2-2a3.58 3.58 0 0 0-5 0 3.5 3.5 0 0 0 0 5l2 2-5 5a4 4 0 0 0 0 5.66L10.33 27A4 4 0 0 0 16 27l12-12zm-1.14 10.57a2 2 0 0 1-1.93-2.51l-2.47-2.48-2-2a1.5 1.5 0 0 1 0-2.12 1.54 1.54 0 0 1 2.11 0l2 2-.68.68 2.48 2.48a2 2 0 1 1 .51 3.93z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
fill_color_l : String -> Int -> Element.Element msg
fill_color_l cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M29.7 25.7c-.5-1-2.7-4.7-2.7-4.7s-2.2 3.7-2.7 4.7a3 3 0 1 0 5.4 0zm-2.3 2.2c-.5.2-1.1 0-1.3-.5-.1-.3-.1-.6 0-.9.1-.3.5-.9.9-1.6.4.7.8 1.3.9 1.6.2.6 0 1.2-.5 1.4zM16 3l-2.1 2.1-2-2a3.5 3.5 0 0 0-5 0C5.7 4.4 5.7 6.6 7 8l2 2-5 5a3.98 3.98 0 0 0 0 5.7l6.3 6.3c1.6 1.6 4.1 1.6 5.7 0l12-12L16 3zM8.4 6.6c-.6-.6-.6-1.6 0-2.2s1.5-.6 2.1 0l2 2-2.1 2.1-2-1.9zm6.2 19c-.8.8-2 .8-2.8 0l-6.3-6.3c-.8-.8-.8-2 0-2.8l5-5 2.1 2.1c0 .2-.1.3-.1.5 0 1.1.9 2 2 2s2-.9 2-2-.9-2-2-2c-.2 0-.4 0-.5.1L11.9 10 16 5.8l9.2 9.2-10.6 10.6z", SA.fill cl ] []
        ]


{-| -}
folder_f : String -> Int -> Element.Element msg
folder_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M28 8H16l-1.37-2.86A2 2 0 0 0 12.83 4H5.5a2 2 0 0 0-1.92 1.45L2 11v15a2 2 0 0 0 2 2h24a2 2 0 0 0 2-2V10a2 2 0 0 0-2-2z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
folder_l : String -> Int -> Element.Element msg
folder_l cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M28 8H16l-1.37-2.86A2 2 0 0 0 12.83 4H5.5a2 2 0 0 0-1.92 1.45L2 11v15a2 2 0 0 0 2 2h24a2 2 0 0 0 2-2V10a2 2 0 0 0-2-2zm0 18H4V11.28L5.5 6h7.33l1.37 2.86.54 1.14H28z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
gift_f : String -> Int -> Element.Element msg
gift_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M5 27a2 2 0 0 0 2 2h6V18H5zm10-9h2v11h-2zm4 11h6a2 2 0 0 0 2-2v-9h-8zM15 9h2v7h-2zm-4-6a4 4 0 0 0-4 4 3.96 3.96 0 0 0 .56 2H5a2 2 0 0 0-2 2v5h10V9h-2a2 2 0 1 1 2-2v2h2V7a4 4 0 0 0-4-4zm16 6h-2.56A3.96 3.96 0 0 0 25 7a4 4 0 0 0-8 0v2h2V7a2 2 0 1 1 2 2h-2v7h10v-5a2 2 0 0 0-2-2z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
gift_l : String -> Int -> Element.Element msg
gift_l cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M29 16v-5a2 2 0 0 0-2-2h-2.56A3.96 3.96 0 0 0 25 7a4 4 0 0 0-8 0v2h-2V7a4 4 0 0 0-8 0 3.96 3.96 0 0 0 .56 2H5a2 2 0 0 0-2 2v5h10v11H7v-9H5v9a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2v-9h-2v9h-6V16zM19 7a2 2 0 1 1 2 2h-2zm0 4h8v3h-8zm-6 3H5v-3h8zm0-5h-2a2 2 0 1 1 2-2zm4 18h-2V16h2zm0-13h-2v-3h2z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
heart_f : String -> Int -> Element.Element msg
heart_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M30 10.58A7.53 7.53 0 0 0 16 6.7a7.53 7.53 0 0 0-14 3.9C2 20.32 16 29 16 29s14-8.67 14-18.42z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
heart_l : String -> Int -> Element.Element msg
heart_l cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M22.6 3.07a7.52 7.52 0 0 0-6.5 3.62 7.53 7.53 0 0 0-14.04 3.74C1.96 20.18 15.86 29 15.86 29s14.1-8.52 14.2-18.27a7.56 7.56 0 0 0-7.46-7.66zm-1 18.95a46.06 46.06 0 0 1-5.71 4.58 46.06 46.06 0 0 1-5.61-4.7C7.4 19.06 4 14.77 4.06 10.46a5.57 5.57 0 0 1 5.6-5.53 5.49 5.49 0 0 1 4.71 2.77l1.69 2.9 1.75-2.87a5.49 5.49 0 0 1 4.77-2.66 5.57 5.57 0 0 1 5.48 5.64c-.05 4.32-3.54 8.53-6.46 11.31z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
home_f : String -> Int -> Element.Element msg
home_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
home_l : String -> Int -> Element.Element msg
home_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
image_f : String -> Int -> Element.Element msg
image_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
image_l : String -> Int -> Element.Element msg
image_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
keyboard_f : String -> Int -> Element.Element msg
keyboard_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M28 6H4a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h24a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2zm-9 5h2v2h-2zm0 4h2v2h-2zm-4-4h2v2h-2zm0 4h2v2h-2zm-4-4h2v2h-2zm0 4h2v2h-2zm-4-4h2v2H7zm0 4h2v2H7zm16 6H9v-2h14zm2-4h-2v-2h2zm0-4h-2v-2h2z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
keyboard_l : String -> Int -> Element.Element msg
keyboard_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
language_f : String -> Int -> Element.Element msg
language_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
language_l : String -> Int -> Element.Element msg
language_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
laptop_f : String -> Int -> Element.Element msg
laptop_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M27 5a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v12h22zm-2 10H7V5h18zm3.94 11.52L27.41 19H4.59l-1.53 7.51A1.99 1.99 0 0 0 4.94 29h22.12a1.99 1.99 0 0 0 1.88-2.48zM17 21h2v2h-2zm-4 0h2v2h-2zm-2 2H9v-2h2zm9 4h-8v-2h8zm3-4h-2v-2h2z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
laptop_l : String -> Int -> Element.Element msg
laptop_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
like_f : String -> Int -> Element.Element msg
like_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M5 14H2v16h3a2 2 0 0 0 2-2V16a2 2 0 0 0-2-2zm23 0h-9s2-6 2-8V3.5A1.5 1.5 0 0 0 19.5 2H19c-.53 0-1 1-1 1l-2 4-6.41 6.41A2 2 0 0 0 9 14.83V26a4 4 0 0 0 4 4h10.17a2 2 0 0 0 1.42-.59l4.82-4.82a2 2 0 0 0 .59-1.42V16a2 2 0 0 0-2-2z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
like_l : String -> Int -> Element.Element msg
like_l cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M5 14H2v2h3v12H2v2h3a2 2 0 0 0 2-2V16a2 2 0 0 0-2-2zm23 0h-8s2-6 2-8V5a2.94 2.94 0 0 0-2.5-3H18c-.53 0-1 1-1 1l-2 4-5.41 6.41A2 2 0 0 0 9 14.83V26a4 4 0 0 0 4 4h10.17a2 2 0 0 0 1.42-.59l4.82-4.82a2 2 0 0 0 .59-1.42V16a2 2 0 0 0-2-2zm0 9.17L23.17 28H13a2 2 0 0 1-2-2V14.83l.06-.06.05-.07 5.42-6.41.15-.18.1-.22L18.75 4h.65A1.05 1.05 0 0 1 20 5v1a41.18 41.18 0 0 1-1.9 7.37L17.23 16H28z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
list_f : String -> Int -> Element.Element msg
list_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
list_l : String -> Int -> Element.Element msg
list_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
loading_l : String -> Int -> Element.Element msg
loading_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill cl, SA.fillRule "evenodd", SA.d "M18.46 2.7A13.55 13.55 0 0 1 29.54 16a13.55 13.55 0 0 1-27.08 0 13.5 13.5 0 0 1 4.8-10.32 13.52 13.52 0 0 1 6.28-2.98V.2A15.99 15.99 0 1 0 32 16C32 8 26.13 1.4 18.46.2v2.5z" ] []
        ]


{-| -}
location_f : String -> Int -> Element.Element msg
location_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 3A10 10 0 0 0 6 13c0 7 10 16 10 16s10-9 10-16A10 10 0 0 0 16 3zm0 13a3 3 0 1 1 3-3 3 3 0 0 1-3 3z", SA.fill cl ] []
        ]


{-| -}
location_l : String -> Int -> Element.Element msg
location_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
login_l : String -> Int -> Element.Element msg
login_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
logout_l : String -> Int -> Element.Element msg
logout_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
lucky_kuji_f : String -> Int -> Element.Element msg
...
{-| -}
lucky_kuji_l : String -> Int -> Element.Element msg
...
{-| -}
mail_f : String -> Int -> Element.Element msg
mail_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
mail_l : String -> Int -> Element.Element msg
mail_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
map_f : String -> Int -> Element.Element msg
map_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
map_l : String -> Int -> Element.Element msg
map_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
menu : String -> Int -> Element.Element msg
menu cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M4 6h24v2H4zm0 9h24v2H4zm0 9h24v2H4z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
minus : String -> Int -> Element.Element msg
minus cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.fill cl, SA.d "M4 15h24v2H4z" ] []
        ]


{-| -}
mobile_phone_f : String -> Int -> Element.Element msg
mobile_phone_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M22 5H11V3a1 1 0 0 0-2 0v2.19A3 3 0 0 0 7 8v19a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3zm-10 5h8v6h-8zm1 16h-2v-2h2zm0-4h-2v-2h2zm4 4h-2v-2h2zm0-4h-2v-2h2zm4 4h-2v-2h2zm0-4h-2v-2h2z", SA.fill cl, SA.fillRule "evenodd" ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
mobile_phone_l : String -> Int -> Element.Element msg
...
{-| -}
movie_f : String -> Int -> Element.Element msg
movie_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M28 4H4a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h24a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zM12 8h3v2h-3zm-2 16H7v-2h3zm0-14H7V8h3zm5 14h-3v-2h3zm5 0h-3v-2h3zm-7-4v-8l7 4zm7-10h-3V8h3zm5 14h-3v-2h3zm0-14h-3V8h3z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
movie_l : String -> Int -> Element.Element msg
movie_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
new_user_f : String -> Int -> Element.Element msg
new_user_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M8 3a2 2 0 0 0-2 2v16.87a2 2 0 0 0 .97 1.71L14 27.8v-2.33l-6-3.6V5l6 3.6V6.27L9.03 3.3A1.98 1.98 0 0 0 8 3zm16 0a1.98 1.98 0 0 0-1.03.29L16 7.47V29l9.03-5.42a2 2 0 0 0 .97-1.71V5a2 2 0 0 0-2-2z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
new_window_l : String -> Int -> Element.Element msg
...
{-| -}
notice_generic_f : String -> Int -> Element.Element msg
notice_generic_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 30a4 4 0 0 0 4-4h-8a4 4 0 0 0 4 4zm10-10v-8a10 10 0 0 0-20 0v8a2 2 0 0 1-2 2v2h24v-2a2 2 0 0 1-2-2z", SA.fill cl ] []
        ]


{-| -}
notice_generic_l : String -> Int -> Element.Element msg
notice_generic_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 28a2 2 0 0 1-2-2h-2a4 4 0 0 0 8 0h-2a2 2 0 0 1-2 2zm10-8v-8a10 10 0 0 0-20 0v8a2 2 0 0 1-2 2v2h24v-2a2 2 0 0 1-2-2zM7.46 22A3.98 3.98 0 0 0 8 20v-8a8 8 0 0 1 16 0v8a3.98 3.98 0 0 0 .54 2z", SA.fill cl ] []
        ]


{-| -}
notice_user_f : String -> Int -> Element.Element msg
notice_user_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M27 3H5a2 2 0 0 0-2 2v18a2 2 0 0 0 2 2h6l5 5 5-5h6a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2zM15 7h2v9h-2zm1 14a1.5 1.5 0 1 1 1.5-1.5A1.5 1.5 0 0 1 16 21z", SA.fill cl ] []
        ]


{-| -}
notice_user_l : String -> Int -> Element.Element msg
...
{-| -}
paint_f : String -> Int -> Element.Element msg
paint_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M29.7 25.7c-.48-1-2.7-4.7-2.7-4.7s-2.22 3.7-2.7 4.7a3 3 0 1 0 5.4 0zM16.1 3.02l-1.31 1.3-1.13-1.19a3.87 3.87 0 0 0-5.48 5.48l1.16 1.17-5.18 5.17a3.97 3.97 0 0 0 0 5.62l6.29 6.28a3.97 3.97 0 0 0 5.61 0L28 14.92zM16 14a2 2 0 0 1-1.96-2.4l-3.26-3.26-.02.02L9.59 7.2a1.88 1.88 0 0 1 2.63-2.67l1.16 1.21-1.19 1.19 3.18 3.18A1.98 1.98 0 0 1 16 10a2 2 0 0 1 0 4z", SA.fill cl ] []
        ]


{-| -}
paint_l : String -> Int -> Element.Element msg
paint_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M29.7 25.7c-.48-1-2.7-4.7-2.7-4.7s-2.22 3.7-2.7 4.7a3 3 0 1 0 5.4 0zM27 28a1 1 0 0 1-1-1 .99.99 0 0 1 .1-.43 34 34 0 0 1 .9-1.63 34 34 0 0 1 .9 1.63.99.99 0 0 1 .1.43 1 1 0 0 1-1 1zM16.1 3.02l-1.31 1.3-1.13-1.19a3.87 3.87 0 0 0-5.48 5.48l1.16 1.17-5.18 5.17a3.97 3.97 0 0 0 0 5.62l6.29 6.28a3.97 3.97 0 0 0 5.61 0L28 14.92zM9.6 4.54a1.87 1.87 0 0 1 2.62-.01l1.15 1.21-2.62 2.62L9.6 7.2a1.88 1.88 0 0 1 0-2.65zm5.05 20.9a1.97 1.97 0 0 1-2.79 0l-6.28-6.28a1.97 1.97 0 0 1 0-2.8l5.18-5.17 2.31 2.31a2.04 2.04 0 1 0 1.4-1.42l-2.3-2.3 3.93-3.93 9.07 9.07z", SA.fill cl ] []
        ]


{-| -}
paper_plane_f : String -> Int -> Element.Element msg
paper_plane_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M28.01 5a2.06 2.06 0 0 0-.43.05l-24 5.14a2 2 0 0 0-.77 3.56L4.51 15l20-7.25L9.23 16 8 16.66V27l6.36-4.74 4.74 3.5a2 2 0 0 0 3-.8l7.72-17.14A2 2 0 0 0 28 5z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M32 32H0V0h32z" ] []
        ]


{-| -}
paper_plane_l : String -> Int -> Element.Element msg
paper_plane_l cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M28.01 5a2.06 2.06 0 0 0-.43.05l-24 5.14a2 2 0 0 0-.77 3.56l2.7 1.99 1.94-1.05L4 12.14l20.5-4.39L9.24 16 8 16.66V27l6.36-4.74 4.74 3.5a2 2 0 0 0 3-.8l7.72-17.14A2 2 0 0 0 28 5zM10 23.02v-3.97l2.68 1.97zm10.28 1.12l-9.27-6.83 16.31-8.8z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M32 32H0V0h32z" ] []
        ]


{-| -}
pdf_f : String -> Int -> Element.Element msg
pdf_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
pdf_l : String -> Int -> Element.Element msg
pdf_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
photograph_l : String -> Int -> Element.Element msg
...
{-| -}
point_l : String -> Int -> Element.Element msg
point_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
price_f : String -> Int -> Element.Element msg
price_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M16 2a14 14 0 1 0 14 14A14 14 0 0 0 16 2zm6 12v2h-4.72l-.28.41V18h5v2h-5v4h-2v-4h-5v-2h5v-1.59l-.28-.41H10v-2h3.37L10 9h2.41L16 14.32 19.59 9H22l-3.37 5z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
price_l : String -> Int -> Element.Element msg
price_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
            [ Svg.path [ SA.d "M16 2a14 14 0 1 0 14 14A14 14 0 0 0 16 2zm0 26a12 12 0 1 1 12-12 12.01 12.01 0 0 1-12 12z" ] []
...
{-| -}
print_f : String -> Int -> Element.Element msg
print_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
print_l : String -> Int -> Element.Element msg
print_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
purchase_history_f : String -> Int -> Element.Element msg
...
{-| -}
purchase_history_l : String -> Int -> Element.Element msg
...
{-| -}
qrcode_f : String -> Int -> Element.Element msg
qrcode_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
            [ Svg.path [ SA.d "M4 24H2v6h6v-2H4v-4zM4 4h4V2H2v6h2V4zm24 24h-4v2h6v-6h-2v4zM24 2v2h4v4h2V2h-6z" ] []
...
{-| -}
qrcode_l : String -> Int -> Element.Element msg
qrcode_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
rakuten_registration_l : String -> Int -> Element.Element msg
...
{-| -}
ranking_f : String -> Int -> Element.Element msg
ranking_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M4.84 27.17a2 2 0 0 0 2 1.83h18.33a2 2 0 0 0 1.99-1.83l.2-2.17H4.64zM22 12l-6-9-6 9-7-5 1.46 16h23.08L29 7l-7 5z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
ranking_l : String -> Int -> Element.Element msg
ranking_l cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M22 12l-6-9-6 9-7-5 1.46 16h23.08L29 7zm3.71 9H6.3l-.9-9.84 3.45 2.47 1.68 1.2 1.14-1.72L16 6.6l4.34 6.5 1.14 1.72 1.68-1.2 3.45-2.47zm-.54 6H6.83l-.18-2h-2l.2 2.17A2 2 0 0 0 6.82 29h18.34a2 2 0 0 0 1.99-1.83l.2-2.17h-2.01z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
refresh : String -> Int -> Element.Element msg
refresh cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M27 16a11.04 11.04 0 1 1-2.94-7.47L21.59 11H28V4.59l-2.53 2.53A12.98 12.98 0 1 0 29 16z", SA.fill cl ] []
        ]


{-| -}
review_comment_f : String -> Int -> Element.Element msg
review_comment_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M27 3H5a2 2 0 0 0-2 2v18a2 2 0 0 0 2 2h7l4 4 4-4h7a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2zM16 19H9v-2h7zm7-4H9v-2h14zm0-4H9V9h14z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
review_comment_l : String -> Int -> Element.Element msg
...
{-| -}
review_edit_f : String -> Int -> Element.Element msg
review_edit_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M24.56 9.43l1.41 1.42 1.44-1.45a2 2 0 0 0 0-2.83l-3.98-3.98a2 2 0 0 0-2.83 0l-1.45 1.44 1.42 1.41zm0 2.83l-1.42-1.42-3.99-3.98-1.4-1.41-11.8 11.79L4 26l8.76-1.95zM6.63 23.36l1-4.43 3.45 3.45zM4 28h24v2H4z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
review_edit_l : String -> Int -> Element.Element msg
review_edit_l cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M22.01 4L26 7.99l-1.44 1.44 1.41 1.41 1.44-1.44a2 2 0 0 0 0-2.83l-3.98-3.98a2 2 0 0 0-2.83 0l-1.45 1.44 1.42 1.41zm2.55 8.26l-1.42-1.41-5.4-5.4-11.8 11.79L4 26l8.76-1.95zM6.63 23.36l1-4.43 3.45 3.45zm2.14-6.12l8.97-8.97 3.99 3.99-8.97 8.97zM4 28h24v2H4z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
rss_symbol_l : String -> Int -> Element.Element msg
...
{-| -}
rss_text_f : String -> Int -> Element.Element msg
rss_text_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
rss_text_l : String -> Int -> Element.Element msg
rss_text_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
save_f : String -> Int -> Element.Element msg
save_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M23 3H5a2 2 0 0 0-2 2v22a2 2 0 0 0 2 2h22a2 2 0 0 0 2-2V9zM10 5h7v4h2V5h3v5a2 2 0 0 1-2 2h-8a2 2 0 0 1-2-2zm13 22H9v-6a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
save_l : String -> Int -> Element.Element msg
save_l cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M23 3H5a2 2 0 0 0-2 2v22a2 2 0 0 0 2 2h22a2 2 0 0 0 2-2V9zM11 5h6v4h2V5h2v6H11zm11 22H10v-7h12zm5 0h-3v-7a2 2 0 0 0-2-2H10a2 2 0 0 0-2 2v7H5V5h4v6a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V5.83l4 4z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
search_history_f : String -> Int -> Element.Element msg
...
{-| -}
search_history_l : String -> Int -> Element.Element msg
...
{-| -}
search : String -> Int -> Element.Element msg
search cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M13 2a11 11 0 1 0 11 11A11 11 0 0 0 13 2zm0 20a9 9 0 1 1 9-9 9.01 9.01 0 0 1-9 9zm9.86-.55a13.11 13.11 0 0 1-1.41 1.41L28.59 30 30 28.59z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
security_f : String -> Int -> Element.Element msg
security_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M11.07 8a4 4 0 0 1 4-4h1.86a4 4 0 0 1 4 4v4h2V8a6.02 6.02 0 0 0-6-6h-1.86a6.02 6.02 0 0 0-6 6v4h2zM24 14H8a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V16a2 2 0 0 0-2-2zm-7 7.72V25h-2v-3.28a2 2 0 1 1 2 0z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
security_l : String -> Int -> Element.Element msg
security_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
server_f : String -> Int -> Element.Element msg
server_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
share_f : String -> Int -> Element.Element msg
share_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M25 21a3.97 3.97 0 0 0-3 1.38l-11.1-5.54a3.9 3.9 0 0 0 0-1.68L22 9.62a3.94 3.94 0 1 0-.9-1.78L10 13.38a4 4 0 1 0 0 5.24l11.09 5.54A4 4 0 1 0 25 21z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
share_l : String -> Int -> Element.Element msg
share_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M24.5 20a4.48 4.48 0 0 0-3.6 1.83l-9.1-4.55a4.05 4.05 0 0 0 0-2.56l9.1-4.55a4.52 4.52 0 1 0-.81-1.83l-9.28 4.64a4.5 4.5 0 1 0 0 6.04l9.28 4.64A4.5 4.5 0 1 0 24.5 20zm0-15A2.5 2.5 0 1 1 22 7.5 2.5 2.5 0 0 1 24.5 5zm-17 13.5A2.5 2.5 0 1 1 10 16a2.5 2.5 0 0 1-2.5 2.5zm17 8.5a2.5 2.5 0 1 1 2.5-2.5 2.5 2.5 0 0 1-2.5 2.5z", SA.fill cl ] []
        ]


{-| -}
shop_f : String -> Int -> Element.Element msg
shop_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
shop_l : String -> Int -> Element.Element msg
shop_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
sign_ban_f : String -> Int -> Element.Element msg
sign_ban_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 2a14 14 0 1 0 14 14A14 14 0 0 0 16 2zm6.33 21.73L8.28 9.67a10.1 10.1 0 0 1 1.4-1.4l14.06 14.07a10.1 10.1 0 0 1-1.4 1.4z", SA.fill cl ] []
        ]


{-| -}
sign_ban_l : String -> Int -> Element.Element msg
sign_ban_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
sign_help_f : String -> Int -> Element.Element msg
sign_help_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 2a14 14 0 1 0 14 14A14 14 0 0 0 16 2zm0 22a1.5 1.5 0 1 1 1.5-1.5A1.5 1.5 0 0 1 16 24zm1-7.12V19h-2v-3a1 1 0 0 1 1-1 2.5 2.5 0 1 0-2.5-2.5v.5h-2v-.5a4.5 4.5 0 1 1 5.5 4.38z", SA.fill cl ] []
        ]


{-| -}
sign_help_l : String -> Int -> Element.Element msg
sign_help_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
sign_info_f : String -> Int -> Element.Element msg
sign_info_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 2a14 14 0 1 0 14 14A14 14 0 0 0 16 2zm1 21h-2v-9h2zm-1-11a1.5 1.5 0 1 1 1.5-1.5A1.5 1.5 0 0 1 16 12z", SA.fill cl ] []
        ]


{-| -}
sign_info_l : String -> Int -> Element.Element msg
sign_info_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
sign_warning_f : String -> Int -> Element.Element msg
sign_warning_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M29.82 25.94L17.25 3.72a1.45 1.45 0 0 0-2.5 0L2.18 25.94A1.4 1.4 0 0 0 3.43 28h25.14a1.4 1.4 0 0 0 1.25-2.06zM15 10h2v9h-2zm1 14a1.5 1.5 0 1 1 1.5-1.5A1.5 1.5 0 0 1 16 24z", SA.fill cl ] []
        ]


{-| -}
sign_warning_l : String -> Int -> Element.Element msg
...
{-| -}
sliders_f : String -> Int -> Element.Element msg
sliders_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M24 6a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2H3v2h15a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2h5V6zm-2 16h-2a2 2 0 0 0-2 2H3v2h15a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2h5v-2h-5a2 2 0 0 0-2-2zm-11-9H9a2 2 0 0 0-2 2H3v2h4a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2h16v-2H13a2 2 0 0 0-2-2z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
sliders_l : String -> Int -> Element.Element msg
sliders_l cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M24 6a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2H3v2h15a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2h5V6zm-2 2h-2V6h2zm0 14h-2a2 2 0 0 0-2 2H3v2h15a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2h5v-2h-5a2 2 0 0 0-2-2zm0 4h-2v-2h2zM11 13H9a2 2 0 0 0-2 2H3v2h4a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2h16v-2H13a2 2 0 0 0-2-2zm0 4H9v-2h2z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
smartphone_f : String -> Int -> Element.Element msg
smartphone_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M22 3H10a3 3 0 0 0-3 3v20a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3V6a3 3 0 0 0-3-3zm1 20H9V8h14z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
smartphone_l : String -> Int -> Element.Element msg
smartphone_l cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M22 3H10a3 3 0 0 0-3 3v20a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3V6a3 3 0 0 0-3-3zm1 23a1 1 0 0 1-1 1H10a1 1 0 0 1-1-1v-2h14zm0-4H9V9h14zm0-15H9V6a1.01 1.01 0 0 1 1-1h12a1.01 1.01 0 0 1 1 1z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
survey_f : String -> Int -> Element.Element msg
survey_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
survey_l : String -> Int -> Element.Element msg
survey_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
switch_language_f : String -> Int -> Element.Element msg
switch_language_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M21.5 14.09A7.18 7.18 0 0 0 23.13 12h-3.26a7.18 7.18 0 0 0 1.63 2.09zM8.92 14h2.16L10 10.87 8.92 14z", SA.fill cl ] []
...
{-| -}
switch_language_l : String -> Int -> Element.Element msg
switch_language_l cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M8.74 16h3.52l.7 2H15l-3.1-9H9.1L6 18h2.05zm1.76-5.13L11.58 14H9.42zM26 18v-2a7.4 7.4 0 0 1-3.3-.76A8.27 8.27 0 0 0 24.78 12H26v-2h-4V8h-2v2h-4v2h1.22a8.27 8.27 0 0 0 2.08 3.24A7.4 7.4 0 0 1 16 16v2a9.37 9.37 0 0 0 5-1.43A9.37 9.37 0 0 0 26 18zm-6.63-6h3.26A7.18 7.18 0 0 1 21 14.09 7.18 7.18 0 0 1 19.37 12z", SA.fill cl ] []
        , Svg.path [ SA.d "M28 2H4a2 2 0 0 0-2 2v19a2 2 0 0 0 2 2h7.5l4.5 5 4.5-5H28a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2zm0 21h-8.39l-.6.66L16 27.01l-3.01-3.35-.6-.66H4V4h24z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
tablet_f : String -> Int -> Element.Element msg
tablet_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M25 2H7a3 3 0 0 0-3 3v22a3 3 0 0 0 3 3h18a3 3 0 0 0 3-3V5a3 3 0 0 0-3-3zm-2 22H9V7h14z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
tablet_l : String -> Int -> Element.Element msg
tablet_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
tag_f : String -> Int -> Element.Element msg
tag_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M25.2 14.63L14.63 25.2 25.2 14.63z" ] []
        , Svg.path [ SA.d "M15.4 2H4.06A2.06 2.06 0 0 0 2 4.06V15.4L13.21 26.6l13.4-13.4zM9 11a2 2 0 1 1 2-2 2 2 0 0 1-2 2zm20.4 5l-1.37-1.37-13.4 13.4L16 29.4a2.06 2.06 0 0 0 2.92 0L29.4 18.92a2.06 2.06 0 0 0 0-2.92z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
tag_l : String -> Int -> Element.Element msg
tag_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
time_f : String -> Int -> Element.Element msg
time_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.d "M16 2a14 14 0 1 0 14 14A14 14 0 0 0 16 2zm6.6 17.92L15 16.66V7h2v8.34l6.4 2.74z", SA.fill cl ] []
        ]


{-| -}
time_l : String -> Int -> Element.Element msg
time_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
            [ Svg.path [ SA.d "M16 2a14 14 0 1 0 14 14A14 14 0 0 0 16 2zm0 26a12 12 0 1 1 12-12 12.01 12.01 0 0 1-12 12z" ] []
...
{-| -}
upload_f : String -> Int -> Element.Element msg
upload_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
upload_l : String -> Int -> Element.Element msg
upload_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
voice_input_f : String -> Int -> Element.Element msg
...
{-| -}
voice_input_l : String -> Int -> Element.Element msg
...
{-| -}
walking_f : String -> Int -> Element.Element msg
walking_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
world_f : String -> Int -> Element.Element msg
world_f cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
world_l : String -> Int -> Element.Element msg
world_l cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M16 2a14 14 0 1 0 14 14A14 14 0 0 0 16 2zm10.9 9a11.88 11.88 0 0 1 1.05 4h-5.97a30.47 30.47 0 0 0-.38-4zm-1.17-2h-4.54a16.06 16.06 0 0 0-1.77-4.5 12.03 12.03 0 0 1 6.3 4.5zm-13.71 6a27.88 27.88 0 0 1 .4-4h7.16a27.88 27.88 0 0 1 .4 4zm7.96 2a27.88 27.88 0 0 1-.4 4h-7.16a27.88 27.88 0 0 1-.4-4zM16 4c.89 0 2.24 1.8 3.12 5h-6.24c.88-3.2 2.23-5 3.12-5zm-3.42.5A16.06 16.06 0 0 0 10.81 9H6.27a12.03 12.03 0 0 1 6.31-4.5zM5.11 11h5.29a30.47 30.47 0 0 0-.38 4H4.05a11.88 11.88 0 0 1 1.05-4zm0 10a11.88 11.88 0 0 1-1.06-4h5.97a30.47 30.47 0 0 0 .38 4zm1.16 2h4.54a16.06 16.06 0 0 0 1.77 4.5 12.03 12.03 0 0 1-6.3-4.5zM16 28c-.89 0-2.24-1.8-3.12-5h6.24c-.88 3.2-2.23 5-3.12 5zm3.42-.5a16.06 16.06 0 0 0 1.77-4.5h4.54a12.03 12.03 0 0 1-6.31 4.5zm7.47-6.5h-5.3a30.47 30.47 0 0 0 .39-4h5.97a11.88 11.88 0 0 1-1.06 4z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
x : String -> Int -> Element.Element msg
x cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.path [ SA.fill cl, SA.d "M27 6.45L25.55 5 16 14.55 6.45 5 5 6.45 14.55 16 5 25.55 6.45 27 16 17.45 25.55 27 27 25.55 17.45 16 27 6.45z" ] []
        ]


{-| -}
zip_f : String -> Int -> Element.Element msg
zip_f cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
zip_l : String -> Int -> Element.Element msg
zip_l cl size =
    wrapper_ size
        [ Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        , Svg.g [ SA.fill cl ]
...
{-| -}
zoom_in_f : String -> Int -> Element.Element msg
zoom_in_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M22.86 21.45a13.11 13.11 0 0 1-1.41 1.41L28.59 30 30 28.59zM13 2a11 11 0 1 0 11 11A11 11 0 0 0 13 2zm4 12h-3v3h-2v-3H9v-2h3V9h2v3h3z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
zoom_in_l : String -> Int -> Element.Element msg
zoom_in_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
...
{-| -}
zoom_out_f : String -> Int -> Element.Element msg
zoom_out_f cl size =
    wrapper_ size
        [ Svg.path [ SA.d "M22.86 21.45a13.11 13.11 0 0 1-1.41 1.41L28.59 30 30 28.59zM13 2a11 11 0 1 0 11 11A11 11 0 0 0 13 2zm4 12H9v-2h8z", SA.fill cl ] []
        , Svg.path [ SA.fill "none", SA.d "M0 0h32v32H0z" ] []
        ]


{-| -}
zoom_out_l : String -> Int -> Element.Element msg
zoom_out_l cl size =
    wrapper_ size
        [ Svg.g [ SA.fill cl ]
