module Pages.Form_FieldType_Multi exposing
    ( Model
    , Msg
    , init
    , title
...
title =
    { key = "title"
    , en_us = "Form Field Type - Multi"
    , ja_jp = "Form Field Type - Multi"
    , zh_tw = "Form Field Type - Multi"
    , es_es = "Form Field Type - Multi"
    , fr_fr = "Form Field Type - Multi"
    , de_de = "Form Field Type - Multi"
    , it_it = "Form Field Type - Multi"
    , nl_nl = "Form Field Type - Multi"
    , pt_pt = "Form Field Type - Multi"
    , nb_no = "Form Field Type - Multi"
    , fi_fl = "Form Field Type - Multi"
    , da_dk = "Form Field Type - Multi"
    , sv_se = "Form Field Type - Multi"
    }
